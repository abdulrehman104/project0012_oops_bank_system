    ...
    do {
        ...
        if (services.select === "view balance") {
            ...
            if (account) {
                ...
                console.log(`Dear ${chalk.green.bold.italic(name?.fname)}  ${chalk.green.bold.italic(name?.lname)} Your Account balance is  ${chalk.green.bold.italic("$", account.balance)}`);
            }
        }
        // Cash with draw
